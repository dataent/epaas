...
dataent.provide("epaas_integrations.shopify_settings");

dataent.ui.form.on("Shopify Settings", "onload", function(frm){
	dataent.call({
		method:"epaas.epaas_integrations.doctype.shopify_settings.shopify_settings.get_series",
		callback:function(r){
	...
	epaas_integrations.shopify_settings.setup_queries(frm);
})

dataent.ui.form.on("Shopify Settings", "app_type", function(frm) {
	frm.toggle_reqd("api_key", (frm.doc.app_type == "Private"));
	frm.toggle_reqd("password", (frm.doc.app_type == "Private"));
})

dataent.ui.form.on("Shopify Settings", "refresh", function(frm){
...
$.extend(epaas_integrations.shopify_settings, {
