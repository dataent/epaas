...
dataent.ui.form.on("Program Enrollment Tool", {
	setup: function(frm) {
	...
	"refresh": function(frm) {
		...
		dataent.realtime.on("program_enrollment_tool", function(data) {
			dataent.hide_msgprint(true);
			dataent.show_progress(__("Enrolling students"), data.progress[0], data.progress[1]);
		});
	},
