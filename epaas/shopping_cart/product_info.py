...
import dataent
from epaas.shopping_cart.cart import _get_cart_quotation
from epaas.shopping_cart.doctype.shopping_cart_settings.shopping_cart_settings \
...
def get_product_info_for_website(item_code):
	...
	product_info = {
		...
		"qty": 0,
		"uom": dataent.db.get_value("Item", item_code, "stock_uom"),
		"show_stock_qty": show_quantity_in_website(),
		"sales_uom": dataent.db.get_value("Item", item_code, "sales_uom")
	}
