...
import dataent
from dataent.utils import add_days, nowdate

class TestContract(unittest.TestCase):

	def setUp(self):
		dataent.db.sql("delete from `tabContract`")
	...
	def test_validate_start_date_before_end_date(self):
		...
		self.assertRaises(dataent.ValidationError, self.contract_doc.insert)
