...
from epaas.setup.doctype.setup_progress.setup_progress import get_action_completed_state
...
def get_slide_settings():
	...
	doc = dataent.get_doc("Setup Progress")
	...
	return [
		dataent._dict(
			...
			# image_src="/assets/epaas/images/illustrations/shop.jpg",
			fields=[],
			...
			help_links=[
				{
					...
					"url": ["https://epaas.xyz/docs/user/manual/en/accounts/chart-of-accounts"]
				},
				{
		...
		dataent._dict(
			...
			submit_method="epaas.utilities.user_progress_utils.set_sales_target",
			done_state_title=_("Go to " + company),
			done_state_title_route=["Form", "Company", company],
			help_links=[
				{
					"label": _('Learn More'),
					"url": ["https://epaas.xyz/docs/user/manual/en/setting-up/setting-company-sales-goal"]
				}
			]
		),
		dataent._dict(
			...
			submit_method="epaas.utilities.user_progress_utils.create_customers",
			done_state_title=_("Go to Customers"),
			done_state_title_route=["List", "Customer"],
			help_links=[
				{
					"label": _('Learn More'),
					"url": ["https://epaas.xyz/docs/user/manual/en/CRM/customer.html"]
				}
			]
		),
		...
		dataent._dict(
			...
			mandatory_entry=1,
			submit_method="epaas.utilities.user_progress_utils.create_letterhead",
		...
		dataent._dict(
			...
			add_more=1, max_count=3, mandatory_entry=1,
			submit_method="epaas.utilities.user_progress_utils.create_suppliers",
			done_state_title=_("Go to Suppliers"),
			done_state_title_route=["List", "Supplier"],
			help_links=[
				{
					"label": _('Learn More'),
					"url": ["https://epaas.xyz/docs/user/manual/en/buying/supplier"]
				},
				{
		...
		dataent._dict(
			...
			add_more=1, max_count=3, mandatory_entry=1,
			submit_method="epaas.utilities.user_progress_utils.create_items",
		...
		dataent._dict(
			...
			add_more=1, max_count=3, mandatory_entry=1,
			submit_method="epaas.utilities.user_progress_utils.create_program",
		...
		dataent._dict(
			...
			add_more=1, max_count=3, mandatory_entry=1,
			submit_method="epaas.utilities.user_progress_utils.create_course",
		...
		dataent._dict(
			...
			add_more=1, max_count=3, mandatory_entry=1,
			submit_method="epaas.utilities.user_progress_utils.create_instructor",
		...
		dataent._dict(
			...
			add_more=1, max_count=3, mandatory_entry=1,
			submit_method="epaas.utilities.user_progress_utils.create_room",
		...
		dataent._dict(
			...
			add_more=1, max_count=3, mandatory_entry=1,
			submit_method="epaas.utilities.user_progress_utils.create_users",
			done_state_title=_("Go to Users"),
			done_state_title_route=["List", "User"],
			help_links=[
				{
					"label": _('Learn More'),
					"url": ["https://epaas.xyz/docs/user/manual/en/setting-up/users-and-permissions"]
				},
				{
