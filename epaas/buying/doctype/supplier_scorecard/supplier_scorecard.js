...
/* global dataent, refresh_field */

dataent.ui.form.on("Supplier Scorecard", {
	setup: function(frm) {
	...
	load_criteria: function(frm) {
		dataent.call({
			method: "epaas.buying.doctype.supplier_scorecard_criteria.supplier_scorecard_criteria.get_criteria_list",
			callback: function(r) {
...
dataent.ui.form.on("Supplier Scorecard Scoring Standing", {

	standing_name: function(frm, cdt, cdn) {
		var d = dataent.get_doc(cdt, cdn);
		if (d.standing_name) {
			return frm.call({
				method: "epaas.buying.doctype.supplier_scorecard_standing.supplier_scorecard_standing.get_scoring_standing",
				child: d,
				args: {
...
dataent.ui.form.on("Supplier Scorecard Scoring Criteria", {
...
var loadAllStandings = function(frm) {
	dataent.call({
		method: "epaas.buying.doctype.supplier_scorecard_standing.supplier_scorecard_standing.get_standings_list",
		callback: function(r) {
