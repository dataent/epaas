...
from epaas.exceptions import PartyDisabled
from dataent.test_runner import make_test_records

test_dependencies = ['Payment Term', 'Payment Terms Template']
test_records = dataent.get_test_records('Supplier')
...
class TestSupplier(unittest.TestCase):
    def test_supplier_default_payment_terms(self):
        ...
        dataent.db.set_value("Supplier", "_Test Supplier With Template 1", "payment_terms", "")

        # Set credit limit for the supplier group instead of supplier and evaluate the due date
        dataent.db.set_value("Supplier Group", "_Test Supplier Group", "payment_terms", "_Test Payment Term Template 3")

        due_date = get_due_date("2016-01-22", "Supplier", "_Test Supplier With Template 1")
        self.assertEqual(due_date, "2016-02-21")

        # Payment terms for Supplier Group instead of supplier and evaluate the due date
        dataent.db.set_value("Supplier Group", "_Test Supplier Group", "payment_terms", "_Test Payment Term Template 1")
        ...
        dataent.db.set_value("Supplier Group", "_Test Supplier Group", "payment_terms", "")
        dataent.db.set_value("Supplier", "_Test Supplier", "payment_terms", "")
    ...
    def test_supplier_disabled(self):
        ...
        dataent.db.set_value("Supplier", "_Test Supplier", "disabled", 1)
        ...
        dataent.db.set_value("Supplier", "_Test Supplier", "disabled", 0)

        po.save()

    def test_supplier_country(self):
        # Test that country field exists in Supplier DocType
        supplier = dataent.get_doc('Supplier', '_Test Supplier with Country')
