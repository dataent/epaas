...
def get_item_price_qty_data(filters):
	...
	item_results = dataent.db.sql("""select a.item_code, a.item_name, a.name as price_list_name,
	...
	price_list_names = list(set([dataent.db.escape(item.price_list_name) for item in item_results]))
...
def get_price_map(price_list_names, buying=0, selling=0):
	...
	pricing_details = dataent.db.sql("""
		select
