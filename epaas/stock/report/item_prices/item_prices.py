...
def get_item_details(conditions):
	...
	for i in dataent.db.sql("""select name, item_group, item_name, description,
...
def get_price_list():
	...
	price_list = dataent.db.sql("""select ip.item_code, ip.buying, ip.selling,
...
def get_last_purchase_rate():
	...
	for d in dataent.db.sql(query, as_dict=1):
...
def get_item_bom_rate():
	...
	for b in dataent.db.sql("""select item, (total_cost/quantity) as bom_rate
...
def get_valuation_rate():
	...
	for d in dataent.db.sql("""select item_code,
