...
from epaas.stock.report.stock_balance.stock_balance import (get_item_details,
	get_item_reorder_details, get_item_warehouse_map, get_items, get_stock_ledger_entries)
from epaas.stock.report.stock_ageing.stock_ageing import get_fifo_queue, get_average_age
...
def validate_filters(filters):
	...
	if not filters.get("company"):
		filters["company"] = dataent.defaults.get_user_default("Company")
