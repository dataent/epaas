...
from epaas.stock.get_item_details import get_price_list_rate_for, process_args
from epaas.stock.doctype.item_price.item_price import ItemPriceDuplicateItem
...
class TestItemPrice(unittest.TestCase):
	...
	def test_duplicate_item(self):
		doc = dataent.copy_doc(test_records[0])
	...
	def test_price_in_a_qty(self):
		...
		doc = dataent.copy_doc(test_records[2])
	...
	def test_prices_at_invalid_date(self):
		...
		doc = dataent.copy_doc(test_records[3])
	...
	def test_prices_outside_of_date(self):
		...
		doc = dataent.copy_doc(test_records[4])
...
test_records = dataent.get_test_records('Item Price')
