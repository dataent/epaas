...
dataent.ui.form.on("Warehouse", {
	refresh: function(frm) {
		...
		frm.add_custom_button(__("Stock Balance"), function() {
			dataent.set_route("query-report", "Stock Balance", {"warehouse": frm.doc.name});
		});
		...
		dataent.dynamic_link = {doc: frm.doc, fieldname: 'name', doctype: 'Warehouse'};
...
function convert_to_group_or_ledger(frm){
	dataent.call({
		method:"epaas.stock.doctype.warehouse.warehouse.convert_to_group_or_ledger",
		args: {
