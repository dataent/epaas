...
from dataent.utils import now_datetime, nowdate, add_days, add_months
...
from epaas.hr.doctype.salary_structure.test_salary_structure \
...
class TestTimesheet(unittest.TestCase):
	def setUp(self):
		...
		if not dataent.db.exists("Salary Component", "Timesheet Component"):
			dataent.get_doc({"doctype": "Salary Component", "salary_component": "Timesheet Component"}).insert()
	...
	def test_salary_slip_from_timesheet(self):
		...
		timesheet = dataent.get_doc('Timesheet', timesheet.name)
...
def update_activity_type(activity_type):
	activity_type = dataent.get_doc('Activity Type',activity_type)
