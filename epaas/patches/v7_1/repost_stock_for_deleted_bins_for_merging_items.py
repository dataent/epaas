...
def execute():
	...
	modified_items = dataent.db.sql_list("""
	...
	for doctype in transactions:
		item_warehouses_with_transactions += list(dataent.db.sql("""
	...
	item_warehouses_with_bin = list(dataent.db.sql("select distinct item_code, warehouse from `tabBin`"))
