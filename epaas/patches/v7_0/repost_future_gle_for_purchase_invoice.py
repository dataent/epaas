...
def execute():
	company_list = dataent.db.sql_list("""Select name from tabCompany where enable_perpetual_inventory = 1""")
	...
	for pi in dataent.get_all("Purchase Invoice", fields=["name", "company"], filters={"docstatus": 1, "update_stock": 1}):
