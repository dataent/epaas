...
def execute():
	...
	dataent.reload_doc("setup", "doctype", "setup_progress")
	dataent.reload_doc("setup", "doctype", "setup_progress_action")
	...
	actions = [
		...
		{"action_name": "Set Sales Target", "action_doctype": "Company", "min_doc_count": 99,
			"action_document": dataent.defaults.get_defaults().get("company") or '',
	...
	setup_progress = dataent.get_doc("Setup Progress", "Setup Progress")
