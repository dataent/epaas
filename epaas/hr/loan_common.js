...
dataent.ui.form.on(cur_frm.doctype, {
	refresh: function(frm) {
		if (!dataent.boot.active_domains.includes("Non Profit")) {
	...
	applicant: function(frm) {
		if (frm.doc.applicant) {
			dataent.model.with_doc(frm.doc.applicant_type, frm.doc.applicant, function() {
				var applicant = dataent.model.get_doc(frm.doc.applicant_type, frm.doc.applicant);
