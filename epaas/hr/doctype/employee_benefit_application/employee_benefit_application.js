...
dataent.ui.form.on('Employee Benefit Application', {
	employee: function(frm) {
		frm.trigger('set_earning_component');
		var method, args;
		if(frm.doc.employee && frm.doc.date && frm.doc.payroll_period){
			method = "epaas.hr.doctype.employee_benefit_application.employee_benefit_application.get_max_benefits_remaining";
			args = {
			...
			method = "epaas.hr.doctype.employee_benefit_application.employee_benefit_application.get_max_benefits";
			args = {
				employee: frm.doc.employee,
				on_date: frm.doc.date
			};
...
dataent.ui.form.on("Employee Benefit Application Detail",{
	amount:  function(frm) {
		calculate_all(frm.doc);
	},
