...
import dataent
import unittest
from epaas.hr.doctype.staffing_plan.staffing_plan import SubsidiaryCompanyError
from epaas.hr.doctype.staffing_plan.staffing_plan import ParentCompanyError
...
def make_company():
	if dataent.db.exists("Company", "_Test Company 10"):
		return
