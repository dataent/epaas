...
dataent.ui.form.on("Salary Slip", {
	setup: function(frm) {
...
dataent.ui.form.on('Salary Slip Timesheet', {
...
var total_work_hours = function(frm, dt, dn) {
	...
	dataent.db.get_value('Salary Structure', {'name': frm.doc.salary_structure}, 'salary_component', (r) => {
		var gross_pay = 0.0;
