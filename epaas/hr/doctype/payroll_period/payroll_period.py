...
from dataent.utils import date_diff, getdate, formatdate, cint, month_diff, flt
from dataent.model.document import Document
from epaas.hr.utils import get_holidays_for_employee
...
class PayrollPeriod(Document):
	...
	def validate_overlap(self):
		...
		overlap_doc = dataent.db.sql(query.format(self.doctype),{
...
def get_period_factor(employee, start_date, end_date, payroll_frequency, payroll_period, depends_on_payment_days=0):
	...
	joining_date, relieving_date = dataent.db.get_value("Employee", employee, ["date_of_joining", "relieving_date"])
