...
# 		return dataent.get_doc('Compensatory Leave Request', dict(
# 			employee = employee,
...
#
# 		dataent.db.set_value('Leave Type', compensatory_leave_request.leave_type, 'max_leaves_allowed', 0)
#
# 		self.assertRaises(MaxLeavesLimitCrossed, compensatory_leave_request.submit)
#
# 		dataent.db.set_value('Leave Type', compensatory_leave_request.leave_type, 'max_leaves_allowed', 10)
#
