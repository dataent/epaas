...
dataent.ui.form.on('Employee Loan', {
	onload: function (frm) {
	...
	make_jv: function (frm) {
		dataent.call({
			...
			method: "epaas.hr.doctype.employee_loan.employee_loan.make_jv_entry",
			callback: function (r) {
				if (r.message)
	...
	employee_loan_application: function (frm) {
	    if(frm.doc.employee_loan_application){
            return dataent.call({
                method: "epaas.hr.doctype.employee_loan.employee_loan.get_employee_loan_application",
                args: {
