...
from dataent.utils import nowdate, add_days, add_years, getdate, add_months
from epaas.hr.doctype.salary_structure.salary_structure import make_salary_slip
from epaas.hr.doctype.salary_slip.test_salary_slip import make_earning_salary_component,\
...
class TestSalaryStructure(unittest.TestCase):
	...
	def test_amount_totals(self):
		...
		sal_slip = dataent.get_value("Salary Slip", {"employee_name":"test_employee_2@salary.com"})
		if not sal_slip:
