...
dataent.ui.form.on('Job Opening', {
	onload: function(frm) {
	...
	designation: function(frm) {
		if(frm.doc.designation && frm.doc.company){
			dataent.call({
				"method": "epaas.hr.doctype.staffing_plan.staffing_plan.get_active_staffing_plan_details",
				args: {
					company: frm.doc.company,
					designation: frm.doc.designation,
					date: dataent.datetime.now_date() // ToDo - Date in Job Opening?
				},
