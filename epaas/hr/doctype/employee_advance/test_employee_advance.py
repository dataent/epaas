...
from epaas.hr.doctype.employee_advance.employee_advance import make_bank_entry
from epaas.hr.doctype.employee_advance.employee_advance import EmployeeAdvanceOverPayment
...
def make_employee_advance():
	doc = dataent.new_doc("Employee Advance")
