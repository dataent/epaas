...
cur_frm.cscript.onload_post_render = function(doc,cdt,cdn){
	if(doc.__islocal && doc.employee==dataent.defaults.get_user_default("Employee")) {
...
cur_frm.cscript.kra_template = function(doc, dt, dn) {
	...
	epaas.utils.map_current_doc({
		method: "epaas.hr.doctype.appraisal.appraisal.fetch_appraisal_template",
...
cur_frm.cscript.score = function(doc,cdt,cdn){
	...
	if (d.score){
		if (flt(d.score) > 5) {
			dataent.msgprint(__("Score must be less than or equal to 5"));
			d.score = 0;
