...
class TestLoanApplication(unittest.TestCase):
	...
	def create_loan_type(self):
		if not dataent.db.get_value("Loan Type", "Home Loan"):
			dataent.get_doc({
				"doctype": "Loan Type",
				"loan_name": "Home Loan",
	...
	def create_loan_application(self):
		if not dataent.db.get_value("Loan Application", {"applicant":self.applicant}, "name"):
			loan_application = dataent.new_doc("Loan Application")
	...
	def test_loan_totals(self):
		loan_application = dataent.get_doc("Loan Application", {"applicant":self.applicant})
