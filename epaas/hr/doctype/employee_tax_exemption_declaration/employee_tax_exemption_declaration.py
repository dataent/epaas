...
from epaas.hr.utils import validate_tax_declaration, get_total_exemption_amount, calculate_annual_eligible_hra_exemption

class DuplicateDeclarationError(dataent.ValidationError): pass
...
class EmployeeTaxExemptionDeclaration(Document):
	...
	def validate_duplicate(self):
		duplicate = dataent.db.get_value("Employee Tax Exemption Declaration",
			filters = {
		...
		if duplicate:
			dataent.throw(_("Duplicate Tax Declaration of {0} for period {1}")
