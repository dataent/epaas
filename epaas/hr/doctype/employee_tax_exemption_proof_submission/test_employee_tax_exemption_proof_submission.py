...
import dataent
import unittest
# from epaas.hr.doctype.employee_tax_exemption_declaration.test_employee_tax_exemption_declaration import create_exemption_category, create_payroll_period
#
...
# 		dataent.db.sql("""delete from `tabEmployee Tax Exemption Proof Submission`""")
#
# 	def test_exemption_amount_lesser_than_category_max(self):
# 		declaration = dataent.get_doc({
# 			"doctype": "Employee Tax Exemption Proof Submission",
# 			"employee": dataent.get_value("Employee", {"user_id":"employee@proofsubmission.com"}, "name"),
