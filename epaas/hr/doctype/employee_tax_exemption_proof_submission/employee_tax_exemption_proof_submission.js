...
dataent.ui.form.on('Employee Tax Exemption Proof Submission', {
	setup: function(frm) {
		...
		if(frm.doc.docstatus === 0) {
			...
			frm.add_custom_button(__('Get Details From Declaration'), function() {
				epaas.utils.map_current_doc({
					method: "epaas.hr.doctype.employee_tax_exemption_declaration.employee_tax_exemption_declaration.make_proof_submission",
