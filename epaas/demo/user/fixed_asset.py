...
from epaas.assets.doctype.asset.asset import make_purchase_invoice, make_sales_invoice
from epaas.assets.doctype.asset.depreciation import post_depreciation_entries, scrap_asset
...
def work():
	...
	dataent.db.set_value("Company", "Wind Power LLC", "disposal_account", "Gain/Loss on Asset Disposal - WPL")
...
def get_random_asset():
	return dataent.db.sql(""" select name, item_code, value_after_depreciation, gross_purchase_amount
		from `tabAsset` 
