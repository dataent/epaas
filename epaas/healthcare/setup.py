...
from epaas.setup.utils import insert_record

def setup_healthcare():
	if dataent.db.exists('Medical Department', 'Cardiology'):
		# already setup
		return
...
def create_medical_departments():
	...
	for department in departments:
		mediacal_department = dataent.new_doc("Medical Department")
...
def create_antibiotics():
	...
	for a in abt:
		antibiotic = dataent.new_doc("Antibiotic")
