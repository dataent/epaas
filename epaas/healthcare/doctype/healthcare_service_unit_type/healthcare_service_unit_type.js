...
dataent.ui.form.on('Healthcare Service Unit Type', {
...
var disable = function(frm){
	var doc = frm.doc;
	dataent.call({
		method: "epaas.healthcare.doctype.healthcare_service_unit_type.healthcare_service_unit_type.disable_enable",
...
var change_item_code = function(frm, doc){
	...
	var change_item_code_from_unit_type = function(item_code, doc){
		dataent.call({
			"method": "epaas.healthcare.doctype.healthcare_service_unit_type.healthcare_service_unit_type.change_item_code",
