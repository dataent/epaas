...
dataent.ui.form.on('Clinical Procedure Template', {
...
var disable_template = function(doc){
	dataent.call({
		method: "epaas.healthcare.doctype.clinical_procedure_template.clinical_procedure_template.disable_enable_template",
...
var change_item_code_from_template = function(item_code, doc){
	dataent.call({
		"method": "epaas.healthcare.doctype.clinical_procedure_template.clinical_procedure_template.change_item_code_from_template",
