...
const dataent_ui_tests_path = path_join(apps_path, 'dataent', 'dataent', 'tests', 'ui');

const login = require(dataent_ui_tests_path + "/login.js")['Login'];
const welcome = require(dataent_ui_tests_path + "/setup_wizard.js")['Welcome'];
const region = require(dataent_ui_tests_path + "/setup_wizard.js")['Region'];
const user = require(dataent_ui_tests_path + "/setup_wizard.js")['User'];
