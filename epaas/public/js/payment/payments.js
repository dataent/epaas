...
epaas.payments = epaas.stock.StockController.extend({
	...
	make_keyboard: function(){
		var me = this;
		$(this.$body).empty();
		$(this.$body).html(dataent.render_template('pos_payment', this.frm.doc))
	...
	make_multimode_payment: function(){
		...
		this.payments = dataent.model.add_child(this.frm.doc, 'Multi Mode Payment', "payments");
	...
	show_payment_details: function(){
		...
		if(this.frm.doc.payments.length){
			$.each(this.frm.doc.payments, function(index, data){
				$(dataent.render_template('payment_details', {
	...
	show_amounts: function(){
		...
		$(this.$body).find('.outstanding_amount').text(format_currency(this.frm.doc.outstanding_amount, dataent.get_doc(":Company", this.frm.doc.company).default_currency))
		this.update_invoice();
	}
})