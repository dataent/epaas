...
def run_setup_wizard_test():
	...
	dataent.db.set_value("Company", "For Testing", "write_off_account", "Write Off - FT")
	dataent.db.set_value("Company", "For Testing", "exchange_gain_loss_account", "Exchange Gain/Loss - FT")
	dataent.db.commit()
