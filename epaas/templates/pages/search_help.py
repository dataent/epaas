...
import dataent, requests
from dataent import _
from jinja2 import utils
from html2text import html2text
from dataent.utils import sanitize_html
from dataent.utils.global_search import search
...
def get_help_results_sections(text):
	out = []
	settings = dataent.get_doc("Support Settings", "Support Settings")
