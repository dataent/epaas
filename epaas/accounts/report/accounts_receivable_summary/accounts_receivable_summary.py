...
from epaas.accounts.party import get_partywise_advanced_payment_amount
from epaas.accounts.report.accounts_receivable.accounts_receivable import ReceivablePayableReport
...
class AccountsReceivableSummary(ReceivablePayableReport):
	...
	def make_data_dict(self, cols, data):
		data_dict = []
		for d in data:
			data_dict.append(dataent._dict(zip(cols, d)))
