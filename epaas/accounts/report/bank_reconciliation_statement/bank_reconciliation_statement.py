...
import dataent
from dataent.utils import flt, getdate, nowdate
...
def execute(filters=None):
	...
	account_currency = dataent.db.get_value("Account", filters.account, "account_currency")
