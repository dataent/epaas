...
def execute(filters=None):
	...
	currency = filters.presentation_currency or dataent.get_cached_value('Company',  filters.company,  "default_currency")
...
def get_provisional_profit_loss(asset, liability, equity, period_list, company, currency=None, consolidated=False):
	...
	if asset and (liability or equity):
		...
		currency = currency or dataent.get_cached_value('Company',  company,  "default_currency")
		total_row = {
