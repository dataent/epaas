...
import unittest
from dataent.utils import today, getdate, add_days
from epaas.accounts.report.accounts_receivable.accounts_receivable import execute
...
class TestAccountsReceivable(unittest.TestCase):
	def test_accounts_receivable(self):
		dataent.db.sql("delete from `tabSales Invoice` where company='_Test Company 2'")
		dataent.db.sql("delete from `tabGL Entry` where company='_Test Company 2'")
