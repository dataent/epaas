...
import dataent
from dataent.utils import getdate, add_days, today, cint
...
def get_territories(filters):
	...
	territories = dataent.get_all("Territory", fields=["name"], filters=filter_dict)
...
def get_items(filters):
	...
	items = dataent.get_all("Item", fields=["name", "item_group", "item_name", "item_code"], filters=filters_dict, order_by="name")
