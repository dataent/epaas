...
from dataent.utils import add_to_date
...
def setup_mappers(mappers):
	...
	for mapping in mappers:
		...
		doc = dataent.get_doc('Cash Flow Mapper', mapping['name'])
...
def _get_account_type_based_data(filters, account_names, period_list, accumulated_values, opening_balances=0):
	from epaas.accounts.report.cash_flow.cash_flow import get_start_date
