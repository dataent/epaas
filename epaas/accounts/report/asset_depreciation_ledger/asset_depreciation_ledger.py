...
def get_data(filters):
	data = []
	depreciation_accounts = dataent.db.sql_list(""" select name from tabAccount
	...
	gl_entries = dataent.get_all('GL Entry',
...
def get_assets_details(assets):
	...
	for d in dataent.get_all("Asset", fields = fields, filters = {'name': ('in', assets)}):
