...
from dataent import MandatoryError

class TestPricingRule(unittest.TestCase):
	def setUp(self):
		dataent.db.sql("delete from `tabPricing Rule`")
	...
	def test_pricing_rule_for_discount(self):
		...
		dataent.db.sql("update `tabPricing Rule` set priority=NULL where campaign='_Test Campaign'")
