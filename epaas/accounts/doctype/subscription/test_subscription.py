...
import dataent
from epaas.accounts.doctype.subscription.subscription import get_prorata_factor
from dataent.utils.data import nowdate, add_days, add_to_date, add_months, date_diff, flt
...
class TestSubscription(unittest.TestCase):
	...
	def test_restart_active_subscription(self):
		...
		self.assertRaises(dataent.ValidationError, subscription.restart_subscription)
