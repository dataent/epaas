...
dataent.ui.form.on("POS Profile", "onload", function(frm) {
	...
	frm.call({
		method: "epaas.accounts.doctype.pos_profile.pos_profile.get_series",
		callback: function(r) {
			if(!r.exc) {
...
dataent.ui.form.on('POS Profile', {
	setup: function(frm) {
		...
		dataent.db.get_value('POS Settings', 'POS Settings', 'use_pos_in_offline_mode', (r) => {
