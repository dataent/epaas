...
from epaas.accounts.doctype.opening_invoice_creation_tool.opening_invoice_creation_tool import get_temporary_opening_account

class TestOpeningInvoiceCreationTool(unittest.TestCase):
	def make_invoices(self, invoice_type="Sales"):
		doc = dataent.get_single("Opening Invoice Creation Tool")
	...
	def check_expected_values(self, invoices, expected_value, invoice_type="Sales"):
		...
		for invoice_idx, invoice in enumerate(invoices or []):
			si = dataent.get_doc(doctype, invoice)
