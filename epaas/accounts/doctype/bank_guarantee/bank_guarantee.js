...
dataent.ui.form.on('Bank Guarantee', {
	setup: function(frm) {
	...
	reference_docname: function(frm) {
		if (frm.doc.reference_docname && frm.doc.reference_doctype) {
			...
			dataent.call({
				method: "epaas.accounts.doctype.bank_guarantee.bank_guarantee.get_vouchar_detials",
				args: {
	...
	start_date: function(frm) {
		var end_date = dataent.datetime.add_days(cur_frm.doc.start_date, cur_frm.doc.validity - 1);
