...
from epaas.stock.doctype.item.test_item import set_item_variant_settings
from epaas.controllers.item_variant import copy_attributes_to_variant, make_variant_item_code
...
def make_quality_inspection_template():
	...
	if dataent.db.exists("Quality Inspection Template", qc_template):
		return qc_template

	qc = dataent.new_doc("Quality Inspection Template")
