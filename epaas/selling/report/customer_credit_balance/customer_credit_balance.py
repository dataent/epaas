...
from epaas.selling.doctype.customer.customer import get_customer_outstanding, get_credit_limit

def execute(filters=None):
	if not filters: filters = {}
	#Check if customer id is according to naming series or customer name
	customer_naming_type = dataent.db.get_value("Selling Settings", None, "cust_master_name")
...
def get_details(filters):
	...
	return dataent.db.sql("""select name, customer_name,
