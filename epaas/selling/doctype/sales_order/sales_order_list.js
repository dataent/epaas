dataent.listview_settings['Sales Order'] = {
	...
	get_indicator: function (doc) {
		if (doc.status === "Closed") {
			...
			&& flt(doc.per_delivered, 6) < 100 && dataent.datetime.get_diff(doc.delivery_date) < 0) {
	...
	onload: function(listview) {
		var method = "epaas.selling.doctype.sales_order.sales_order.close_or_unclose_sales_orders";
