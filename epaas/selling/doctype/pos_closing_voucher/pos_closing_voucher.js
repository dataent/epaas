...
dataent.ui.form.on('POS Closing Voucher', {
	onload: function(frm) {
		...
		frm.set_query("user", function(doc) {
			return {
				query: "epaas.selling.doctype.pos_closing_voucher.pos_closing_voucher.get_cashiers",
				filters: {
...
dataent.ui.form.on('POS Closing Voucher Details', {
	collected_amount: function(doc, cdt, cdn) {
		var row = locals[cdt][cdn];
		dataent.model.set_value(cdt, cdn, "difference", row.collected_amount - row.expected_amount);
	}
});
