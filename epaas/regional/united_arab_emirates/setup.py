...
def add_print_formats():
	dataent.reload_doc("regional", "print_format", "detailed_tax_invoice")
	dataent.reload_doc("regional", "print_format", "simplified_tax_invoice")
	dataent.reload_doc("regional", "print_format", "tax_invoice")
