...
from dataent.utils import flt, getdate, cint, date_diff
from epaas.assets.doctype.asset.depreciation import get_depreciation_accounts
...
class AssetValueAdjustment(Document):
	...
	def on_cancel(self):
		if self.journal_entry:
			dataent.throw(_("Cancel the journal entry {0} first").format(self.journal_entry))
...
def get_current_asset_value(asset, finance_book=None):
	...
	return dataent.db.get_value('Asset Finance Book', cond, 'value_after_depreciation')
